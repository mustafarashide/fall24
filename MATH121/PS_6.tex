...
\begin{document}
	...
	\begin{parts}
		...
		We are looking for the minimum value of $A(l,w)$ and because both the length and width of the box have to positive our contraints are $l>0$ and $w>0$. The critical points occur where $A_l(l,w)=0$ and $A_w(l,w)=0$. 
		\begin{align}
		...
		\part \textbf{Method 2:} We need to minimize $A(l,w,h)=2lw+2lh+2wh$ subject to the contraint $V(l,w,h)=lwh=38$. Therefore, the Lagrangian function will be:
